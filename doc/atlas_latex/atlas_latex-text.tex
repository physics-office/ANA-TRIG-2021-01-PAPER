...
\item[\Option{linenofix=true|{\normalfont false}}] fix line numbers around AMS math environments without using the \Package{linenomath} environment;
...
\item[\Option{abbrevref={\normalfont true}|false}] abbreviate Fig.\ etc.\ when using \Package{cleverref};
