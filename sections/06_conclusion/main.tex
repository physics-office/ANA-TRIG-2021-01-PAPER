...
The \rnn{} was also studied from an offline likelihood perspective to obtain additional insights into its behavior by using two equivalent single-electron triggers with and without the \rnn{}. 
