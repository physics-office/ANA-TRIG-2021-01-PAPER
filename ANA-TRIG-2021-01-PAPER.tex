...
\include{sections/01_introduction/main} % ok
\include{sections/02_trigger/main}
\include{sections/03_ringer/main} % 
\include{sections/04_operation/main} % ok
\include{sections/05_analysis/main} % ok
\include{sections/06_conclusion/main} % ok
